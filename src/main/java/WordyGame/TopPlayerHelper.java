...
/**
* WordyGame/TopPlayerHelper.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from WordyGame.idl
* Saturday, April 29, 2023 11:49:54 AM SGT
*/

abstract public class TopPlayerHelper
{
  private static String  _id = "IDL:WordyGame/TopPlayer:1.0";
      ...
      synchronized (org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _members0[2] = new org.omg.CORBA.StructMember (
            ...
            _tcOf_members0,
            null);
          __typeCode = org.omg.CORBA.ORB.init ().create_struct_tc (WordyGame.TopPlayerHelper.id (), "TopPlayer", _members0);
          __active = false;
        }
      }
    }
  ...
  {
    WordyGame.TopPlayer value = new WordyGame.TopPlayer ();
