 ...
 implements WordyGame.WordyGameServerOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("getRound", new java.lang.Integer (5));
    _methods.put ("checkMatchStatus", new java.lang.Integer (6));
    _methods.put ("requestLetters", new java.lang.Integer (7));
    _methods.put ("getPlayerID", new java.lang.Integer (8));
    _methods.put ("checkWinner", new java.lang.Integer (9));
    _methods.put ("getTimer", new java.lang.Integer (10));
    _methods.put ("getLongestWords", new java.lang.Integer (11));
    _methods.put ("getTopPlayers", new java.lang.Integer (12));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 5:  // WordyGame/WordyGameServer/getRound
       {
         int gameID = in.read_long ();
         int $result = (int)0;
         $result = this.getRound (gameID);
         out = $rh.createReply();
         out.write_long ($result);
         break;
       }

       case 6:  // WordyGame/WordyGameServer/checkMatchStatus
       {
         int gameID = in.read_long ();
         String $result = null;
         $result = this.checkMatchStatus (gameID);
         out = $rh.createReply();
         out.write_string ($result);
         break;
       }

       case 7:  // WordyGame/WordyGameServer/requestLetters
       {
         int gameID = in.read_long ();
         char $result[] = null;
       ...
       case 8:  // WordyGame/WordyGameServer/getPlayerID
       {
         String username = in.read_string ();
         int $result = (int)0;
         $result = this.getPlayerID (username);
         out = $rh.createReply();
         out.write_long ($result);
         break;
       }

       case 9:  // WordyGame/WordyGameServer/checkWinner
       {
         int gameID = in.read_long ();
         String $result = null;
       ...
       case 10:  // WordyGame/WordyGameServer/getTimer
       {
         int gameID = in.read_long ();
         String of = in.read_string ();
         int $result = (int)0;
         $result = this.getTimer (gameID, of);
         out = $rh.createReply();
         out.write_long ($result);
         break;
       }

       case 11:  // WordyGame/WordyGameServer/getLongestWords
       {
       ...
       case 12:  // WordyGame/WordyGameServer/getTopPlayers
       {
