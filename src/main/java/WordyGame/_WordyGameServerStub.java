...
public class _WordyGameServerStub extends org.omg.CORBA.portable.ObjectImpl implements WordyGame.WordyGameServer
{
  ...
  public String playGame (int userID) throws WordyGame.NoPlayersAvailable
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
  ...
  public void checkWord (String word, String gameID, int userID) throws WordyGame.InvalidWord, WordyGame.WordLessThanFiveLetters, WordyGame.ExceededTimeLimit
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
  ...
  public boolean roundStatus (String gameID)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("roundStatus", true);
                $out.write_string (gameID);
                $in = _invoke ($out);
