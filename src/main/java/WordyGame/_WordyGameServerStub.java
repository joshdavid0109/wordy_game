...
public class _WordyGameServerStub extends org.omg.CORBA.portable.ObjectImpl implements WordyGameServer
{
  ...
  public CredentialsResult login (String username, String password)
  {
            ...
            try {
                ...
                $in = _invoke ($out);
                CredentialsResult $result = CredentialsResultHelper.read ($in);
                return $result;
  ...
  public LobbyStatus playGame (WordyGamePlayer username)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("playGame", true);
                WordyGamePlayerHelper.write ($out, username);
                $in = _invoke ($out);
                LobbyStatus $result = LobbyStatusHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
